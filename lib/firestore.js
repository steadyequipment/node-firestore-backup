...
import { promiseSerial, addMapFunction } from './utility'
...
export class FirestoreBackup {
  ...
  backupCollection(collection: Object, backupPath: string, logPath: string) {
    ...
    return this.Promise.resolve(collection.get())
  ...
  backupDocument(document: Object, backupPath: string, logPath: string) {
    ...
    return this.Promise.resolve(document.ref.getCollections())
      .map((collection) => {
